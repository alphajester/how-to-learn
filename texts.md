...
<!-- здесь я удалю точки для моего макета. текст в колонках в таких влучаях не нуждается в линейных ограничителях, у него есть позиционирование.
и это пример смерти точек номер раз -->
